                ...
                {(navData || []).map((item: any, key: number) => (
                  <React.Fragment key={key}>
                    {item.icon &&
                      (item.subItems ? (
                        <li>
                          <Link onClick={item.click} to="#" sub-items={item.id} className="nav-icon" data-bs-toggle="collapse">
                            <i className={item.icon}></i>
                          </Link>
                        </li>
                      ) : (
                        <>
                          <Link onClick={item.click} to={item.link ? item.link : "/#"} sub-items={item.id} className="nav-icon" data-bs-toggle="collapse">
                            <i className={item.icon}></i>
                          </Link>
                        </>
                      ))}
                                        ...
                                        {subItem.childItems &&
                                          (subItem.childItems || []).map((childItem: any, key: number) => (
                                            <li className="nav-item" key={key}>
                                              <Link to={childItem.link ? childItem.link : "/#"} onClick={childItem.click} className="nav-link">
                                                {childItem.label}
                                              </Link>
