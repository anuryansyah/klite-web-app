...
// Register Method
export const postFakeRegister = (data : any) => api.post(url.POST_FAKE_REGISTER, data);

// Login Method
export const postFakeLogin = (data : any) => api.post(url.POST_FAKE_LOGIN, data);

// postForgetPwd
export const postFakeForgetPwd = (data : any) => api.post(url.POST_FAKE_PASSWORD_FORGET, data);

// Edit profile
export const postJwtProfile = (data : any) => api.post(url.POST_EDIT_JWT_PROFILE, data);
...
// Login Method
export const postJwtLogin = (data : any) => api.post(url.POST_FAKE_JWT_LOGIN, data);

// postForgetPwd
export const postJwtForgetPwd = (data : any) => api.post(url.POST_FAKE_JWT_PASSWORD_FORGET, data);

// postSocialLogin
export const postSocialLogin = (data : any) => api.post(url.SOCIAL_LOGIN, data);
...
// add Events
export const addNewEvent = (event : any) => api.post(url.ADD_NEW_EVENT, event);
...
// add Message
export const addMessage = (message : any) => api.post(url.ADD_MESSAGE, message);
...
// add Products
export const addNewProduct = (product : any) => api.post(url.ADD_NEW_PRODUCT, product);
// update Products
...
// add Order
export const addNewOrder = (order : any) => api.post(url.ADD_NEW_ORDER, order);
...
// add Customers
export const addNewCustomer = (customer : any) => api.post(url.ADD_NEW_CUSTOMER, customer);
...
// add Task
export const addNewTask = (task : any) => api.post(url.ADD_NEW_TASK, task);
...
export const addNewTasks = (card: any) => api.post(url.ADD_TASKS, card)
...
// add Contact
export const addNewContact = (contact : any) => api.post(url.ADD_NEW_CONTACT, contact);
...
// add Companies
export const addNewCompanies = (company : any) => api.post(url.ADD_NEW_COMPANIES, company);
...
// add Lead
export const addNewLead = (lead : any) => api.post(url.ADD_NEW_LEAD, lead);
...
// add Invoice
export const addNewInvoice = (invoice : any) => api.post(url.ADD_NEW_INVOICE, invoice);
...
// add Tickets 
export const addNewTicket = (ticket : any) => api.post(url.ADD_NEW_TICKET, ticket);
...
// Project
export const addProjectList = (project : any) => api.post(url.ADD_NEW_PROJECT, project);
...
export const addTeamData = (team : any) => api.post(url.ADD_NEW_TEAMDATA, team);
...
export const addNewFolder = (folder : any) => api.post(url.ADD_NEW_FOLDER, folder);
...
export const addNewFile = (file : any) => api.post(url.ADD_NEW_FILE, file);
...
export const addNewTodo = (todo : any) => api.post(url.ADD_NEW_TODO, todo);
export const updateTodo = (todo : any) => api.put(url.UPDATE_TODO, todo);

// To do Project
export const getProjects = () => api.get(url.GET_PROJECTS);
export const addNewProject = (project : any) => api.post(url.ADD_NEW_TODO_PROJECT, project);
...
export const addNewJobApplicationList = (job: any) => api.post(url.ADD_NEW_APPLICATION_LIST, job);
...
export const addJobCandidate = (candidate : any) => api.post(url.ADD_NEW_CANDIDATE, candidate);
...
export const addcategoryList = (category : any) => api.post(url.ADD_CATEGORY_LIST, category);

// grid
export const getCandidateGrid = () => api.get(url.GET_CANDIDATE_GRID);
export const addCandidateGrid = (category : any) => api.post(url.ADD_CANDIDATE_GRID, category);