              ...
              <Card>
                <CardHeader>
                  <div className="d-md-flex flex-md-row justify-content-md-between align-items-md-center">
                    ...
                    <button className="btn btn-soft-primary w-md-auto" onClick={toggleModal}>
                ...
                <CardFooter>
                  <div className="d-flex flex-row justify-content-between align-items-center">
                    ...
                    <div className="d-flex gap-2">
                      <button className="btn btn-light" onClick={() => onPrevPage()} disabled={!canGoBack}>
                        <i className="ri-arrow-left-s-line align-middle" />
                      </button>
                      <button className="btn btn-light" onClick={() => onNextPage()} disabled={!canGoNext}>
